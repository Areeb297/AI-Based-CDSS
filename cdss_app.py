...
# It's recommended to set these as actual environment variables in your system
# rather than hardcoding them in the script for better security and flexibility.
# Example:
# os.environ["OPENAI_API_KEY"] = "YOUR_API_KEY"
# os.environ["OPENAI_API_BASE"] = "YOUR_API_BASE_URL"
# For this script, we'll use the provided example values. If you have them set in your environment,
# these lines might not be strictly necessary, or you can adapt them.
os.environ["OPENAI_API_KEY"] = "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" # Replace with your actual key if needed
